            ...
            <section className="col-9 fs-4 d-flex flex-column justify-content-center align-items-center">
                <form onSubmit={handleSubmit} className='w-50'>
                    ...
                    <div>
                        ...
                        <input required type="text" className="form-control" id="dni" name="input_dni" value={dni}
                               onChange={event => setDniOwner(event.target.value)}/>

                    </div>
                    <div>
                        <label>Pisos del Estacionamiento: </label>
                        <input required min='1' type="number" className="form-control" id="floors" name="input_floors"
...
=======
                    ...
                    <div>
                        ...
                        <label>Precio Auto: </label>
                        <input required min="1" type="number" className="form-control" id="car" name="input_carprice"
                               value={fees.car} onChange={event => setFees({fees, auto: event.target.value})}/>

                        <label>Precio Moto: </label>
                        <input required min="1" type="number" className="form-control" id="motorcycle"
                               name="input_motorcycleprice" value={fees.motorcycle}
                               onChange={event => setFees({fees, moto: event.target.value})}/>

                        <label>Precio Camioneta: </label>
                        <input required min="1" type="number" className="form-control" id="truck"
                               name="input_truckprice" value={fees.truck}
                               onChange={event => setFees({fees, camioneta: event.target.value})}/>
>>>>>>> 8582e2256d98ac4bfc199ce733199d28f4a83d5f
