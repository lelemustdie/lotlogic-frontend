            ...
            <section className="col-9 fs-4 d-flex flex-column justify-content-center align-items-center">
                <form onSubmit={handleSubmit} className='w-50'>
                    <div>
                        ...
                        <input required type="number" className="form-control" id="reservationId"
                               name="input_reservationid" value={reservationId}
                               onChange={event => setReservationId(event.target.value)}/>
                    </div>
                    <div>
                        <label>ID del PARKING donde esta estacionado: </label>
                        <input required type="number" className="form-control" id="parkingId" name="input_parkingid"
